...
public class MainController {
	...
	public ModelAndView searchDatabase(Model model, @RequestParam("customerId") int customerId, RedirectAttributes redirectAttributes) {
	...
	public String processSearchRequest(Model model, @ModelAttribute("searchRequest") SearchRequest searchRequest, @RequestParam("customerId") int customerId, RedirectAttributes redirectAttributes) {
	...
	public String rentMovie(Model model, @RequestParam("movieId") int movieId, @RequestParam("customerId") int customerId) {
	...
	public String processMovie(@ModelAttribute("movie") Movie movie) {
		movieService.addMovie(movie);
		return "redirect:/searchMoviesGuest";
	}
