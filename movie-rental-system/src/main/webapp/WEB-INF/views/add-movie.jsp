...
<head>
<meta charset="UTF-8">
<title>Movie Rental System - Add Movie to Database</title>
<link
		...
		<form:form action="processMovie" modelAttribute="movie" method="post"
			...
			<div class="col-md-2">
				...
				<form:input path="releaseDate" type="text" class="form-control"
					id="releaseDate" placeholder="mm/dd/yyyy" />
			</div>
			<div class="col-md-2">
			...
			<div class="col-md-2">
				<label for="numOfCopies" class="form-label"># of Available Copies</label>
				<form:input path="numOfAvailableCopies" type="number" class="form-control"
					id="numOfCopies" value="1" />
			</div>
			<div class="col-md-2">
