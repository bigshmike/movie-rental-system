...
<body>
	<div class="container">
		<form:form action="processSearchRequest" modelAttribute="searchRequest" commandName="newRental" method="post"
			class="row g-3">
			<h1>Search Database</h1>
			<div class="col-12">
			<form:radiobutton class="form-check-input" path="searchType" value="title" name="title" id="title"/> Title
